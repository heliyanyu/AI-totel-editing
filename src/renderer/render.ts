...
async function main() {
  ...
  if (
    ...
    console.error(
      "Usage: npx tsx src/renderer/render.ts -b blueprint.json -t timing_map.json -v video.mp4 -o overlay_layer.mp4"
    );
    console.error(
      "   or: npx tsx src/renderer/render.ts -b blueprint.json -t timing_map.json --source-video doctor.mp4 -o overlay_layer.mp4"
    );
    console.error(
      "   or: npx tsx src/renderer/render.ts -b blueprint.json -t timing_map.json --cut-video cut_video.mp4 -o overlay_layer.mp4"
    );
